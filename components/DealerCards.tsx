...
export function DealerCards({ selectedCard, onSelectCard }: DealerCardsProps) {
  const dealerCards: Card[] = ['2', '3', '4', '5', '6', '7', '8', '9', '10', 'A'];

  return (
    <div className="bg-card p-2 rounded-lg shadow-sm space-y-2">
      <div className="text-sm font-medium text-muted-foreground">Dealer's Card</div>
        ...
        {dealerCards.map(card => (
          <Button
            ...
            className={cn(
              ...
              ["2","3","4","5","6"].includes(card) && "bg-blue-50 hover:bg-blue-100",
